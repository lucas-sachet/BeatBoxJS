...
let beats = {
    ...
    "90": {
        beat: new Beat("./assets/Drum and Bass.mp3"),
        button: new Button("#7FFF00", 90),
    },
    "88": {
        beat: new Beat("./assets/Opening.mp3"),
        button: new Button("#7FFF00", 88),
    },
    "67": {
        beat: new Beat("./assets/Trippin.mp3"),
        button: new Button("#7FFF00", 67),
    }
}
